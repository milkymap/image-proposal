...
# run container 
```bash
    docker run --rm --name image-proposal -gpus all \
        -v /path/to/transformers_cache/:/home/solver/transformers_cache \
        ...
        image-proposal:gpu \ 
            --port 8000 
            --host '0.0.0.0' 
            --img_model_name clip-ViT-L-14
            --nlp_model_name Sahajtomar/french_semantic 
            --chunk_size 128 
            --nb_nlp_workers 1 
            --nb_img_workers 2 
            --mounting_path "/"
